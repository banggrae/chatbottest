...
def main():
    ...
    with st.container():
        st.image('./chatbot_logo_ellis.png', use_container_width=True)
        st.markdown('---')
        st.title("안녕하세요! RAG를 활용한 'AI 비서 앨리스' 입니다")
    ...
    if st.session_state["OPENAI_API"] and st.session_state["SERPAPI_API"]:
        ...
        prompt = ChatPromptTemplate.from_messages(
            [
                ...
                "Your name is `AI 비서 앨리스`. Please introduce yourself at the beginning of the conversation."),
